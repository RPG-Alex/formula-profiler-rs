# `Br` profile for `lotus`

This report summarizes how often the target element `Br` appears across metadata groups in `lotus`.
...
| Positive count | 4218 |
| Negative count | 272300 |
| Positive percentage | 1.5254% |
...
|---|---|---:|---:|---:|---:|
| Source dataset | Lotus | 276518 | 4218 | 1.53% | 100.00% |
| Source dataset | TOTAL_RECORDS | 276518 | 4218 | 1.53% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 276518 | 4218 | 1.53% | 100.00% |
