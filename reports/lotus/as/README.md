# `As` profile for `lotus`

This report summarizes how often the target element `As` appears across metadata groups in `lotus`.
...
| Positive count | 28 |
| Negative count | 276490 |
| Positive percentage | 0.0101% |
...
|---|---|---:|---:|---:|---:|
| Source dataset | Lotus | 276518 | 28 | 0.01% | 100.00% |
| Source dataset | TOTAL_RECORDS | 276518 | 28 | 0.01% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 276518 | 28 | 0.01% | 100.00% |
