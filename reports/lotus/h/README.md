...
This report summarizes how often the target element `H` appears across metadata groups in `lotus`.
...
| Positive count | 276511 |
| Negative count | 7 |
| Positive percentage | 99.9975% |
...
|---|---|---:|---:|---:|---:|
| Source dataset | Lotus | 276518 | 276511 | 100.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 276518 | 276511 | 100.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 276518 | 276511 | 100.00% | 100.00% |
