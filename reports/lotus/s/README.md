...
This report summarizes how often the target element `S` appears across metadata groups in `lotus`.
...
| Positive count | 7777 |
| Negative count | 268741 |
| Positive percentage | 2.8125% |
...
|---|---|---:|---:|---:|---:|
| Source dataset | Lotus | 276518 | 7777 | 2.81% | 100.00% |
| Source dataset | TOTAL_RECORDS | 276518 | 7777 | 2.81% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 276518 | 7777 | 2.81% | 100.00% |
