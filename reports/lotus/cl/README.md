# `Cl` profile for `lotus`

This report summarizes how often the target element `Cl` appears across metadata groups in `lotus`.
...
| Positive count | 6106 |
| Negative count | 270412 |
| Positive percentage | 2.2082% |
...
|---|---|---:|---:|---:|---:|
| Source dataset | Lotus | 276518 | 6106 | 2.21% | 100.00% |
| Source dataset | TOTAL_RECORDS | 276518 | 6106 | 2.21% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 276518 | 6106 | 2.21% | 100.00% |
