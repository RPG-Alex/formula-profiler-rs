...
This report summarizes how often the target element `F` appears across metadata groups in `lotus`.
...
| Positive count | 122 |
| Negative count | 276396 |
| Positive percentage | 0.0441% |
...
|---|---|---:|---:|---:|---:|
| Source dataset | Lotus | 276518 | 122 | 0.04% | 100.00% |
| Source dataset | TOTAL_RECORDS | 276518 | 122 | 0.04% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 276518 | 122 | 0.04% | 100.00% |
