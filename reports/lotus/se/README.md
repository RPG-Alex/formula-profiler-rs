# `Se` profile for `lotus`

This report summarizes how often the target element `Se` appears across metadata groups in `lotus`.
...
| Positive count | 23 |
| Negative count | 276495 |
| Positive percentage | 0.0083% |
...
|---|---|---:|---:|---:|---:|
| Source dataset | Lotus | 276518 | 23 | 0.01% | 100.00% |
| Source dataset | TOTAL_RECORDS | 276518 | 23 | 0.01% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 276518 | 23 | 0.01% | 100.00% |
