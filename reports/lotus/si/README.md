# `Si` profile for `lotus`

This report summarizes how often the target element `Si` appears across metadata groups in `lotus`.
...
| Positive count | 65 |
| Negative count | 276453 |
| Positive percentage | 0.0235% |
...
|---|---|---:|---:|---:|---:|
| Source dataset | Lotus | 276518 | 65 | 0.02% | 100.00% |
| Source dataset | TOTAL_RECORDS | 276518 | 65 | 0.02% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 276518 | 65 | 0.02% | 100.00% |
