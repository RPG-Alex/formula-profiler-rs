...
This report summarizes how often the target element `P` appears across metadata groups in `lotus`.
...
| Positive count | 1104 |
| Negative count | 275414 |
| Positive percentage | 0.3993% |
...
|---|---|---:|---:|---:|---:|
| Source dataset | Lotus | 276518 | 1104 | 0.40% | 100.00% |
| Source dataset | TOTAL_RECORDS | 276518 | 1104 | 0.40% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 276518 | 1104 | 0.40% | 100.00% |
