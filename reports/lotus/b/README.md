...
This report summarizes how often the target element `B` appears across metadata groups in `lotus`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | Lotus | 276518 | 3 | 0.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 276518 | 3 | 0.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 276518 | 3 | 0.00% | 100.00% |
