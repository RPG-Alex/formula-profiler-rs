...
This report summarizes how often the target element `I` appears across metadata groups in `lotus`.
...
| Positive count | 141 |
| Negative count | 276377 |
| Positive percentage | 0.0510% |
...
|---|---|---:|---:|---:|---:|
| Source dataset | Lotus | 276518 | 141 | 0.05% | 100.00% |
| Source dataset | TOTAL_RECORDS | 276518 | 141 | 0.05% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 276518 | 141 | 0.05% | 100.00% |
