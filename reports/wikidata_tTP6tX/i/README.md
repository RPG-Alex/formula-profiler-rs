# `I` profile for `wikidata_tTP6tX`

This report summarizes how often the target element `I` appears across metadata groups in `wikidata_tTP6tX`.
...
| Positive count | 169 |
| Negative count | 546312 |
| Positive percentage | 0.0309% |
...
|---|---|---:|---:|---:|---:|
| Source dataset | wikidata_tTP6tX | 546481 | 169 | 0.03% | 100.00% |
| Source dataset | TOTAL_RECORDS | 546481 | 169 | 0.03% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 546481 | 169 | 0.03% | 100.00% |
