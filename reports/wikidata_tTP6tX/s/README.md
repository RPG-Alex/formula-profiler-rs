# `S` profile for `wikidata_tTP6tX`

This report summarizes how often the target element `S` appears across metadata groups in `wikidata_tTP6tX`.
...
| Positive count | 11514 |
| Negative count | 534967 |
| Positive percentage | 2.1069% |
...
|---|---|---:|---:|---:|---:|
| Source dataset | wikidata_tTP6tX | 546481 | 11514 | 2.11% | 100.00% |
| Source dataset | TOTAL_RECORDS | 546481 | 11514 | 2.11% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 546481 | 11514 | 2.11% | 100.00% |
