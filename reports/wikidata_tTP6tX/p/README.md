# `P` profile for `wikidata_tTP6tX`

This report summarizes how often the target element `P` appears across metadata groups in `wikidata_tTP6tX`.
...
| Positive count | 2560 |
| Negative count | 543921 |
| Positive percentage | 0.4685% |
...
|---|---|---:|---:|---:|---:|
| Source dataset | wikidata_tTP6tX | 546481 | 2560 | 0.47% | 100.00% |
| Source dataset | TOTAL_RECORDS | 546481 | 2560 | 0.47% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 546481 | 2560 | 0.47% | 100.00% |
