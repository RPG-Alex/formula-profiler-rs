# `C` profile for `wikidata_tTP6tX`

This report summarizes how often the target element `C` appears across metadata groups in `wikidata_tTP6tX`.
...
| Positive count | 546148 |
| Negative count | 333 |
| Positive percentage | 99.9391% |
...
|---|---|---:|---:|---:|---:|
| Source dataset | wikidata_tTP6tX | 546481 | 546148 | 99.94% | 100.00% |
| Source dataset | TOTAL_RECORDS | 546481 | 546148 | 99.94% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 546481 | 546148 | 99.94% | 100.00% |
