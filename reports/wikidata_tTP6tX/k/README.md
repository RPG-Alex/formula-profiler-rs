# `K` profile for `wikidata_tTP6tX`

This report summarizes how often the target element `K` appears across metadata groups in `wikidata_tTP6tX`.
...
| Positive count | 33 |
| Negative count | 546448 |
| Positive percentage | 0.0060% |
...
|---|---|---:|---:|---:|---:|
| Source dataset | wikidata_tTP6tX | 546481 | 33 | 0.01% | 100.00% |
| Source dataset | TOTAL_RECORDS | 546481 | 33 | 0.01% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 546481 | 33 | 0.01% | 100.00% |
