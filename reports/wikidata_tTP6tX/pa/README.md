# `Pa` profile for `wikidata_tTP6tX`

This report summarizes how often the target element `Pa` appears across metadata groups in `wikidata_tTP6tX`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | wikidata_tTP6tX | 546481 | 1 | 0.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 546481 | 1 | 0.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 546481 | 1 | 0.00% | 100.00% |
