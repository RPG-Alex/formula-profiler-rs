# `B` profile for `wikidata_tTP6tX`

This report summarizes how often the target element `B` appears across metadata groups in `wikidata_tTP6tX`.
...
| Positive count | 16 |
| Negative count | 546465 |
| Positive percentage | 0.0029% |
...
|---|---|---:|---:|---:|---:|
| Source dataset | wikidata_tTP6tX | 546481 | 16 | 0.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 546481 | 16 | 0.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 546481 | 16 | 0.00% | 100.00% |
