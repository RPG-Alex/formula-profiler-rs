# `F` profile for `wikidata_tTP6tX`

This report summarizes how often the target element `F` appears across metadata groups in `wikidata_tTP6tX`.
...
| Positive count | 319 |
| Negative count | 546162 |
| Positive percentage | 0.0584% |
...
|---|---|---:|---:|---:|---:|
| Source dataset | wikidata_tTP6tX | 546481 | 319 | 0.06% | 100.00% |
| Source dataset | TOTAL_RECORDS | 546481 | 319 | 0.06% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 546481 | 319 | 0.06% | 100.00% |
