# `Si` profile for `wikidata_tTP6tX`

This report summarizes how often the target element `Si` appears across metadata groups in `wikidata_tTP6tX`.
...
| Positive count | 71 |
| Negative count | 546410 |
| Positive percentage | 0.0130% |
...
|---|---|---:|---:|---:|---:|
| Source dataset | wikidata_tTP6tX | 546481 | 71 | 0.01% | 100.00% |
| Source dataset | TOTAL_RECORDS | 546481 | 71 | 0.01% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 546481 | 71 | 0.01% | 100.00% |
