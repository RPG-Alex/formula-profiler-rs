# `Cl` profile for `wikidata_tTP6tX`

This report summarizes how often the target element `Cl` appears across metadata groups in `wikidata_tTP6tX`.
...
| Positive count | 7183 |
| Negative count | 539298 |
| Positive percentage | 1.3144% |
...
|---|---|---:|---:|---:|---:|
| Source dataset | wikidata_tTP6tX | 546481 | 7183 | 1.31% | 100.00% |
| Source dataset | TOTAL_RECORDS | 546481 | 7183 | 1.31% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 546481 | 7183 | 1.31% | 100.00% |
