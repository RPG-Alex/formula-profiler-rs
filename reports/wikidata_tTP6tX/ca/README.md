# `Ca` profile for `wikidata_tTP6tX`

This report summarizes how often the target element `Ca` appears across metadata groups in `wikidata_tTP6tX`.
...
| Positive count | 30 |
| Negative count | 546451 |
| Positive percentage | 0.0055% |
...
|---|---|---:|---:|---:|---:|
| Source dataset | wikidata_tTP6tX | 546481 | 30 | 0.01% | 100.00% |
| Source dataset | TOTAL_RECORDS | 546481 | 30 | 0.01% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 546481 | 30 | 0.01% | 100.00% |
