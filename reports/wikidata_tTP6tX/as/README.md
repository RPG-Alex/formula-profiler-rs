# `As` profile for `wikidata_tTP6tX`

This report summarizes how often the target element `As` appears across metadata groups in `wikidata_tTP6tX`.
...
| Positive count | 87 |
| Negative count | 546394 |
| Positive percentage | 0.0159% |
...
|---|---|---:|---:|---:|---:|
| Source dataset | wikidata_tTP6tX | 546481 | 87 | 0.02% | 100.00% |
| Source dataset | TOTAL_RECORDS | 546481 | 87 | 0.02% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 546481 | 87 | 0.02% | 100.00% |
