# `O` profile for `wikidata_tTP6tX`

This report summarizes how often the target element `O` appears across metadata groups in `wikidata_tTP6tX`.
...
| Positive count | 506021 |
| Negative count | 40460 |
| Positive percentage | 92.5963% |
...
|---|---|---:|---:|---:|---:|
| Source dataset | wikidata_tTP6tX | 546481 | 506021 | 92.60% | 100.00% |
| Source dataset | TOTAL_RECORDS | 546481 | 506021 | 92.60% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 546481 | 506021 | 92.60% | 100.00% |
