# `N` profile for `wikidata_tTP6tX`

This report summarizes how often the target element `N` appears across metadata groups in `wikidata_tTP6tX`.
...
| Metric | Value |
|---|---:|
| Total molecules | 546481 |
| Positive count | 109142 |
| Negative count | 437339 |
| Positive percentage | 19.9718% |
...
|---|---|---:|---:|---:|---:|
| Source dataset | wikidata_tTP6tX | 546481 | 109142 | 19.97% | 100.00% |
| Source dataset | TOTAL_RECORDS | 546481 | 109142 | 19.97% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 546481 | 109142 | 19.97% | 100.00% |
