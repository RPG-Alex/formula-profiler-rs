# `Br` profile for `wikidata_tTP6tX`

This report summarizes how often the target element `Br` appears across metadata groups in `wikidata_tTP6tX`.
...
| Positive count | 5084 |
| Negative count | 541397 |
| Positive percentage | 0.9303% |
...
|---|---|---:|---:|---:|---:|
| Source dataset | wikidata_tTP6tX | 546481 | 5084 | 0.93% | 100.00% |
| Source dataset | TOTAL_RECORDS | 546481 | 5084 | 0.93% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 546481 | 5084 | 0.93% | 100.00% |
