# `Mg` profile for `wikidata_tTP6tX`

This report summarizes how often the target element `Mg` appears across metadata groups in `wikidata_tTP6tX`.
...
| Positive count | 46 |
| Negative count | 546435 |
| Positive percentage | 0.0084% |
...
|---|---|---:|---:|---:|---:|
| Source dataset | wikidata_tTP6tX | 546481 | 46 | 0.01% | 100.00% |
| Source dataset | TOTAL_RECORDS | 546481 | 46 | 0.01% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 546481 | 46 | 0.01% | 100.00% |
