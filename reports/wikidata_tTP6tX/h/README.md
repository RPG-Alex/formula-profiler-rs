# `H` profile for `wikidata_tTP6tX`

This report summarizes how often the target element `H` appears across metadata groups in `wikidata_tTP6tX`.
...
| Positive count | 546233 |
| Negative count | 248 |
| Positive percentage | 99.9546% |
...
|---|---|---:|---:|---:|---:|
| Source dataset | wikidata_tTP6tX | 546481 | 546233 | 99.95% | 100.00% |
| Source dataset | TOTAL_RECORDS | 546481 | 546233 | 99.95% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 546481 | 546233 | 99.95% | 100.00% |
