# `Pb` profile for `wikidata_tTP6tX`

This report summarizes how often the target element `Pb` appears across metadata groups in `wikidata_tTP6tX`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | wikidata_tTP6tX | 546481 | 2 | 0.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 546481 | 2 | 0.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 546481 | 2 | 0.00% | 100.00% |
