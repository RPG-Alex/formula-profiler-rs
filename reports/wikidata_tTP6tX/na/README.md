# `Na` profile for `wikidata_tTP6tX`

This report summarizes how often the target element `Na` appears across metadata groups in `wikidata_tTP6tX`.
...
| Positive count | 23 |
| Negative count | 546458 |
| Positive percentage | 0.0042% |
...
|---|---|---:|---:|---:|---:|
| Source dataset | wikidata_tTP6tX | 546481 | 23 | 0.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 546481 | 23 | 0.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 546481 | 23 | 0.00% | 100.00% |
