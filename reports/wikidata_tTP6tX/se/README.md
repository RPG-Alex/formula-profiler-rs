# `Se` profile for `wikidata_tTP6tX`

This report summarizes how often the target element `Se` appears across metadata groups in `wikidata_tTP6tX`.
...
| Positive count | 41 |
| Negative count | 546440 |
| Positive percentage | 0.0075% |
...
|---|---|---:|---:|---:|---:|
| Source dataset | wikidata_tTP6tX | 546481 | 41 | 0.01% | 100.00% |
| Source dataset | TOTAL_RECORDS | 546481 | 41 | 0.01% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 546481 | 41 | 0.01% | 100.00% |
