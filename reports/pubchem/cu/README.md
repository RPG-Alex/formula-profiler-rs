...
This report treats each spectrum as **positive** when its molecular formula contains the target element `Cu`. A spectrum is **negative** when its formula does not contain `Cu`.
...
|---|---:|
| Total spectra | 67090 |
| Positive count | 67090 |
| Negative count | 0 |
| Positive percentage | 100.0000% |

## Atom-count distribution

This section shows how many formula-bearing spectra have exactly `k` atoms of `Cu`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 67090 | 67090 | 100.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 67090 | 67090 | 100.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 67090 | 67090 | 100.00% | 100.00% |
