...
This report treats each spectrum as **positive** when its molecular formula contains the target element `Cs`. A spectrum is **negative** when its formula does not contain `Cs`.
...
This section shows how many formula-bearing spectra have exactly `k` atoms of `Cs`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 12082 | 12082 | 100.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 12082 | 12082 | 100.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 12082 | 12082 | 100.00% | 100.00% |
