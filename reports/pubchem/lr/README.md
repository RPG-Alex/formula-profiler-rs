...
This report treats each spectrum as **positive** when its molecular formula contains the target element `Lr`. A spectrum is **negative** when its formula does not contain `Lr`.
...
This section shows how many formula-bearing spectra have exactly `k` atoms of `Lr`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 816 | 816 | 100.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 816 | 816 | 100.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 816 | 816 | 100.00% | 100.00% |
