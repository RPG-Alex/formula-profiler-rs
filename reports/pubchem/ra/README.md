...
This report treats each spectrum as **positive** when its molecular formula contains the target element `Ra`. A spectrum is **negative** when its formula does not contain `Ra`.
...
This section shows how many formula-bearing spectra have exactly `k` atoms of `Ra`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 275 | 275 | 100.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 275 | 275 | 100.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 275 | 275 | 100.00% | 100.00% |
