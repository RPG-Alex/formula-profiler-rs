...
This report treats each spectrum as **positive** when its molecular formula contains the target element `Ge`. A spectrum is **negative** when its formula does not contain `Ge`.
...
This section shows how many formula-bearing spectra have exactly `k` atoms of `Ge`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 45899 | 45899 | 100.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 45899 | 45899 | 100.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 45899 | 45899 | 100.00% | 100.00% |
