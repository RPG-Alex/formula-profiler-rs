...
This report treats each spectrum as **positive** when its molecular formula contains the target element `Pd`. A spectrum is **negative** when its formula does not contain `Pd`.
...
|---|---:|
| Total spectra | 48592 |
| Positive count | 48592 |
| Negative count | 0 |
| Positive percentage | 100.0000% |

## Atom-count distribution

This section shows how many formula-bearing spectra have exactly `k` atoms of `Pd`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 48592 | 48592 | 100.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 48592 | 48592 | 100.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 48592 | 48592 | 100.00% | 100.00% |
