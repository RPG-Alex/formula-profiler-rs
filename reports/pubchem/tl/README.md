...
This report treats each spectrum as **positive** when its molecular formula contains the target element `Tl`. A spectrum is **negative** when its formula does not contain `Tl`.
...
This section shows how many formula-bearing spectra have exactly `k` atoms of `Tl`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 6100 | 6100 | 100.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 6100 | 6100 | 100.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 6100 | 6100 | 100.00% | 100.00% |
