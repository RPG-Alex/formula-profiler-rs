...
This report treats each spectrum as **positive** when its molecular formula contains the target element `Dy`. A spectrum is **negative** when its formula does not contain `Dy`.
...
This section shows how many formula-bearing spectra have exactly `k` atoms of `Dy`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 2307 | 2307 | 100.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 2307 | 2307 | 100.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 2307 | 2307 | 100.00% | 100.00% |
