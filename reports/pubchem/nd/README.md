...
This report treats each spectrum as **positive** when its molecular formula contains the target element `Nd`. A spectrum is **negative** when its formula does not contain `Nd`.
...
This section shows how many formula-bearing spectra have exactly `k` atoms of `Nd`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 5563 | 5563 | 100.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 5563 | 5563 | 100.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 5563 | 5563 | 100.00% | 100.00% |
