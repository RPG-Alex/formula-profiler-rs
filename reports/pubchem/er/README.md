...
This report treats each spectrum as **positive** when its molecular formula contains the target element `Er`. A spectrum is **negative** when its formula does not contain `Er`.
...
This section shows how many formula-bearing spectra have exactly `k` atoms of `Er`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 2190 | 2190 | 100.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 2190 | 2190 | 100.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 2190 | 2190 | 100.00% | 100.00% |
