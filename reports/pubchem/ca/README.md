...
This report treats each spectrum as **positive** when its molecular formula contains the target element `Ca`. A spectrum is **negative** when its formula does not contain `Ca`.
...
|---|---:|
| Total spectra | 46989 |
| Positive count | 46989 |
| Negative count | 0 |
| Positive percentage | 100.0000% |

## Atom-count distribution

This section shows how many formula-bearing spectra have exactly `k` atoms of `Ca`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 46989 | 46989 | 100.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 46989 | 46989 | 100.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 46989 | 46989 | 100.00% | 100.00% |
