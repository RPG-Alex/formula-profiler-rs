...
This report treats each spectrum as **positive** when its molecular formula contains the target element `Ac`. A spectrum is **negative** when its formula does not contain `Ac`.
...
This section shows how many formula-bearing spectra have exactly `k` atoms of `Ac`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 9772 | 9772 | 100.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 9772 | 9772 | 100.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 9772 | 9772 | 100.00% | 100.00% |
