...
This report treats each spectrum as **positive** when its molecular formula contains the target element `Ir`. A spectrum is **negative** when its formula does not contain `Ir`.
...
| Metric | Value |
|---|---:|
| Total spectra | 161633 |
| Positive count | 161633 |
| Negative count | 0 |
| Positive percentage | 100.0000% |

## Atom-count distribution

This section shows how many formula-bearing spectra have exactly `k` atoms of `Ir`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 161633 | 161633 | 100.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 161633 | 161633 | 100.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 161633 | 161633 | 100.00% | 100.00% |
