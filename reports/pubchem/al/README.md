...
This report treats each spectrum as **positive** when its molecular formula contains the target element `Al`. A spectrum is **negative** when its formula does not contain `Al`.
...
This section shows how many formula-bearing spectra have exactly `k` atoms of `Al`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 82180 | 82180 | 100.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 82180 | 82180 | 100.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 82180 | 82180 | 100.00% | 100.00% |
