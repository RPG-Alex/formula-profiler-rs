...
This report treats each spectrum as **positive** when its molecular formula contains the target element `Ag`. A spectrum is **negative** when its formula does not contain `Ag`.
...
|---|---:|
| Total spectra | 19055 |
| Positive count | 19055 |
| Negative count | 0 |
| Positive percentage | 100.0000% |

## Atom-count distribution

This section shows how many formula-bearing spectra have exactly `k` atoms of `Ag`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 19055 | 19055 | 100.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 19055 | 19055 | 100.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 19055 | 19055 | 100.00% | 100.00% |
