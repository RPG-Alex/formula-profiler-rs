...
This report treats each spectrum as **positive** when its molecular formula contains the target element `La`. A spectrum is **negative** when its formula does not contain `La`.
...
This section shows how many formula-bearing spectra have exactly `k` atoms of `La`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 8057 | 8057 | 100.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 8057 | 8057 | 100.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 8057 | 8057 | 100.00% | 100.00% |
