...
This report treats each spectrum as **positive** when its molecular formula contains the target element `Po`. A spectrum is **negative** when its formula does not contain `Po`.
...
This section shows how many formula-bearing spectra have exactly `k` atoms of `Po`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 1363 | 1363 | 100.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 1363 | 1363 | 100.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 1363 | 1363 | 100.00% | 100.00% |
