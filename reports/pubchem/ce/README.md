...
This report treats each spectrum as **positive** when its molecular formula contains the target element `Ce`. A spectrum is **negative** when its formula does not contain `Ce`.
...
This section shows how many formula-bearing spectra have exactly `k` atoms of `Ce`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 8210 | 8210 | 100.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 8210 | 8210 | 100.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 8210 | 8210 | 100.00% | 100.00% |
