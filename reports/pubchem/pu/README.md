...
This report treats each spectrum as **positive** when its molecular formula contains the target element `Pu`. A spectrum is **negative** when its formula does not contain `Pu`.
...
This section shows how many formula-bearing spectra have exactly `k` atoms of `Pu`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 575 | 575 | 100.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 575 | 575 | 100.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 575 | 575 | 100.00% | 100.00% |
