...
This report treats each spectrum as **positive** when its molecular formula contains the target element `He`. A spectrum is **negative** when its formula does not contain `He`.
...
This section shows how many formula-bearing spectra have exactly `k` atoms of `He`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 415 | 415 | 100.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 415 | 415 | 100.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 415 | 415 | 100.00% | 100.00% |
