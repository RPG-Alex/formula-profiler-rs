...
This report treats each spectrum as **positive** when its molecular formula contains the target element `Md`. A spectrum is **negative** when its formula does not contain `Md`.
...
This section shows how many formula-bearing spectra have exactly `k` atoms of `Md`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 93 | 93 | 100.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 93 | 93 | 100.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 93 | 93 | 100.00% | 100.00% |
