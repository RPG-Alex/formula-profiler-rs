...
This report treats each spectrum as **positive** when its molecular formula contains the target element `Ta`. A spectrum is **negative** when its formula does not contain `Ta`.
...
This section shows how many formula-bearing spectra have exactly `k` atoms of `Ta`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 5718 | 5718 | 100.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 5718 | 5718 | 100.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 5718 | 5718 | 100.00% | 100.00% |
