...
This report treats each spectrum as **positive** when its molecular formula contains the target element `Es`. A spectrum is **negative** when its formula does not contain `Es`.
...
This section shows how many formula-bearing spectra have exactly `k` atoms of `Es`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 348 | 348 | 100.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 348 | 348 | 100.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 348 | 348 | 100.00% | 100.00% |
