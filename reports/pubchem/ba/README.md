...
This report treats each spectrum as **positive** when its molecular formula contains the target element `Ba`. A spectrum is **negative** when its formula does not contain `Ba`.
...
|---|---:|
| Total spectra | 15732 |
| Positive count | 15732 |
| Negative count | 0 |
| Positive percentage | 100.0000% |

## Atom-count distribution

This section shows how many formula-bearing spectra have exactly `k` atoms of `Ba`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 15732 | 15732 | 100.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 15732 | 15732 | 100.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 15732 | 15732 | 100.00% | 100.00% |
