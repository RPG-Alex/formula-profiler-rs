...
This report treats each spectrum as **positive** when its molecular formula contains the target element `Ni`. A spectrum is **negative** when its formula does not contain `Ni`.
...
|---|---:|
| Total spectra | 50324 |
| Positive count | 50324 |
| Negative count | 0 |
| Positive percentage | 100.0000% |

## Atom-count distribution

This section shows how many formula-bearing spectra have exactly `k` atoms of `Ni`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 50324 | 50324 | 100.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 50324 | 50324 | 100.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 50324 | 50324 | 100.00% | 100.00% |
