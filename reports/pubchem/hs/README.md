...
This report treats each spectrum as **positive** when its molecular formula contains the target element `Hs`. A spectrum is **negative** when its formula does not contain `Hs`.
...
This section shows how many formula-bearing spectra have exactly `k` atoms of `Hs`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 69 | 69 | 100.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 69 | 69 | 100.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 69 | 69 | 100.00% | 100.00% |
