...
This report treats each spectrum as **positive** when its molecular formula contains the target element `Rf`. A spectrum is **negative** when its formula does not contain `Rf`.
...
This section shows how many formula-bearing spectra have exactly `k` atoms of `Rf`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 5122 | 5122 | 100.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 5122 | 5122 | 100.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 5122 | 5122 | 100.00% | 100.00% |
