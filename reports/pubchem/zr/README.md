...
This report treats each spectrum as **positive** when its molecular formula contains the target element `Zr`. A spectrum is **negative** when its formula does not contain `Zr`.
...
| Metric | Value |
|---|---:|
| Total spectra | 106561 |
| Positive count | 106561 |
| Negative count | 0 |
| Positive percentage | 100.0000% |

## Atom-count distribution

This section shows how many formula-bearing spectra have exactly `k` atoms of `Zr`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 106561 | 106561 | 100.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 106561 | 106561 | 100.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 106561 | 106561 | 100.00% | 100.00% |
