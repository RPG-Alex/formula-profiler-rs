...
This report treats each spectrum as **positive** when its molecular formula contains the target element `Zn`. A spectrum is **negative** when its formula does not contain `Zn`.
...
|---|---:|
| Total spectra | 75928 |
| Positive count | 75928 |
| Negative count | 0 |
| Positive percentage | 100.0000% |

## Atom-count distribution

This section shows how many formula-bearing spectra have exactly `k` atoms of `Zn`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 75928 | 75928 | 100.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 75928 | 75928 | 100.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 75928 | 75928 | 100.00% | 100.00% |
