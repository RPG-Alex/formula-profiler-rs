...
This report treats each spectrum as **positive** when its molecular formula contains the target element `U`. A spectrum is **negative** when its formula does not contain `U`.
...
This section shows how many formula-bearing spectra have exactly `k` atoms of `U`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 21201 | 21201 | 100.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 21201 | 21201 | 100.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 21201 | 21201 | 100.00% | 100.00% |
