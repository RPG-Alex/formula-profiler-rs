...
This report treats each spectrum as **positive** when its molecular formula contains the target element `Lu`. A spectrum is **negative** when its formula does not contain `Lu`.
...
This section shows how many formula-bearing spectra have exactly `k` atoms of `Lu`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 2572 | 2572 | 100.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 2572 | 2572 | 100.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 2572 | 2572 | 100.00% | 100.00% |
