...
This report treats each spectrum as **positive** when its molecular formula contains the target element `Hg`. A spectrum is **negative** when its formula does not contain `Hg`.
...
This section shows how many formula-bearing spectra have exactly `k` atoms of `Hg`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 15125 | 15125 | 100.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 15125 | 15125 | 100.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 15125 | 15125 | 100.00% | 100.00% |
