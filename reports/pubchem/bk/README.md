...
This report treats each spectrum as **positive** when its molecular formula contains the target element `Bk`. A spectrum is **negative** when its formula does not contain `Bk`.
...
This section shows how many formula-bearing spectra have exactly `k` atoms of `Bk`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 168 | 168 | 100.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 168 | 168 | 100.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 168 | 168 | 100.00% | 100.00% |
