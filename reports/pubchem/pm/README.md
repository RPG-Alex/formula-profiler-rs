...
This report treats each spectrum as **positive** when its molecular formula contains the target element `Pm`. A spectrum is **negative** when its formula does not contain `Pm`.
...
This section shows how many formula-bearing spectra have exactly `k` atoms of `Pm`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 409 | 409 | 100.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 409 | 409 | 100.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 409 | 409 | 100.00% | 100.00% |
