...
This report treats each spectrum as **positive** when its molecular formula contains the target element `Rn`. A spectrum is **negative** when its formula does not contain `Rn`.
...
This section shows how many formula-bearing spectra have exactly `k` atoms of `Rn`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 138 | 138 | 100.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 138 | 138 | 100.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 138 | 138 | 100.00% | 100.00% |
