...
This report treats each spectrum as **positive** when its molecular formula contains the target element `Th`. A spectrum is **negative** when its formula does not contain `Th`.
...
This section shows how many formula-bearing spectra have exactly `k` atoms of `Th`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 1726 | 1726 | 100.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 1726 | 1726 | 100.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 1726 | 1726 | 100.00% | 100.00% |
