...
This report treats each spectrum as **positive** when its molecular formula contains the target element `Mn`. A spectrum is **negative** when its formula does not contain `Mn`.
...
This section shows how many formula-bearing spectra have exactly `k` atoms of `Mn`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 30805 | 30805 | 100.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 30805 | 30805 | 100.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 30805 | 30805 | 100.00% | 100.00% |
