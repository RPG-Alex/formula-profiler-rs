...
This report treats each spectrum as **positive** when its molecular formula contains the target element `Am`. A spectrum is **negative** when its formula does not contain `Am`.
...
This section shows how many formula-bearing spectra have exactly `k` atoms of `Am`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 378 | 378 | 100.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 378 | 378 | 100.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 378 | 378 | 100.00% | 100.00% |
