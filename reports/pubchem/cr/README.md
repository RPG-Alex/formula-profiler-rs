...
This report treats each spectrum as **positive** when its molecular formula contains the target element `Cr`. A spectrum is **negative** when its formula does not contain `Cr`.
...
|---|---:|
| Total spectra | 27026 |
| Positive count | 27026 |
| Negative count | 0 |
| Positive percentage | 100.0000% |

## Atom-count distribution

This section shows how many formula-bearing spectra have exactly `k` atoms of `Cr`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 27026 | 27026 | 100.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 27026 | 27026 | 100.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 27026 | 27026 | 100.00% | 100.00% |
