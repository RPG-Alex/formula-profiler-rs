...
This report treats each spectrum as **positive** when its molecular formula contains the target element `V`. A spectrum is **negative** when its formula does not contain `V`.
...
This section shows how many formula-bearing spectra have exactly `k` atoms of `V`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 39548 | 39548 | 100.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 39548 | 39548 | 100.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 39548 | 39548 | 100.00% | 100.00% |
