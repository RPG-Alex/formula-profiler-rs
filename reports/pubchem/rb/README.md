...
This report treats each spectrum as **positive** when its molecular formula contains the target element `Rb`. A spectrum is **negative** when its formula does not contain `Rb`.
...
This section shows how many formula-bearing spectra have exactly `k` atoms of `Rb`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 10891 | 10891 | 100.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 10891 | 10891 | 100.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 10891 | 10891 | 100.00% | 100.00% |
