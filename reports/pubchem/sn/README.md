...
This report treats each spectrum as **positive** when its molecular formula contains the target element `Sn`. A spectrum is **negative** when its formula does not contain `Sn`.
...
This section shows how many formula-bearing spectra have exactly `k` atoms of `Sn`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 108730 | 108730 | 100.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 108730 | 108730 | 100.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 108730 | 108730 | 100.00% | 100.00% |
