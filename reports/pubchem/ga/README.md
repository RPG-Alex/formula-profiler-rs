...
This report treats each spectrum as **positive** when its molecular formula contains the target element `Ga`. A spectrum is **negative** when its formula does not contain `Ga`.
...
This section shows how many formula-bearing spectra have exactly `k` atoms of `Ga`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 11598 | 11598 | 100.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 11598 | 11598 | 100.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 11598 | 11598 | 100.00% | 100.00% |
