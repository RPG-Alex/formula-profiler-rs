...
This report treats each spectrum as **positive** when its molecular formula contains the target element `Sm`. A spectrum is **negative** when its formula does not contain `Sm`.
...
This section shows how many formula-bearing spectra have exactly `k` atoms of `Sm`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 3341 | 3341 | 100.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 3341 | 3341 | 100.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 3341 | 3341 | 100.00% | 100.00% |
