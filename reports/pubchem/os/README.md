...
This report treats each spectrum as **positive** when its molecular formula contains the target element `Os`. A spectrum is **negative** when its formula does not contain `Os`.
...
This section shows how many formula-bearing spectra have exactly `k` atoms of `Os`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 8597 | 8597 | 100.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 8597 | 8597 | 100.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 8597 | 8597 | 100.00% | 100.00% |
