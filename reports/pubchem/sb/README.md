...
This report treats each spectrum as **positive** when its molecular formula contains the target element `Sb`. A spectrum is **negative** when its formula does not contain `Sb`.
...
|---|---:|
| Total spectra | 19015 |
| Positive count | 19015 |
| Negative count | 0 |
| Positive percentage | 100.0000% |

## Atom-count distribution

This section shows how many formula-bearing spectra have exactly `k` atoms of `Sb`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 19015 | 19015 | 100.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 19015 | 19015 | 100.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 19015 | 19015 | 100.00% | 100.00% |
