...
This report treats each spectrum as **positive** when its molecular formula contains the target element `Tb`. A spectrum is **negative** when its formula does not contain `Tb`.
...
This section shows how many formula-bearing spectra have exactly `k` atoms of `Tb`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 3106 | 3106 | 100.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 3106 | 3106 | 100.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 3106 | 3106 | 100.00% | 100.00% |
