...
This report treats each spectrum as **positive** when its molecular formula contains the target element `Fm`. A spectrum is **negative** when its formula does not contain `Fm`.
...
This section shows how many formula-bearing spectra have exactly `k` atoms of `Fm`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 2065 | 2065 | 100.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 2065 | 2065 | 100.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 2065 | 2065 | 100.00% | 100.00% |
