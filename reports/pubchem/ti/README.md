...
This report treats each spectrum as **positive** when its molecular formula contains the target element `Ti`. A spectrum is **negative** when its formula does not contain `Ti`.
...
This section shows how many formula-bearing spectra have exactly `k` atoms of `Ti`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 77889 | 77889 | 100.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 77889 | 77889 | 100.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 77889 | 77889 | 100.00% | 100.00% |
