...
This report treats each spectrum as **positive** when its molecular formula contains the target element `Nb`. A spectrum is **negative** when its formula does not contain `Nb`.
...
This section shows how many formula-bearing spectra have exactly `k` atoms of `Nb`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 6583 | 6583 | 100.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 6583 | 6583 | 100.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 6583 | 6583 | 100.00% | 100.00% |
