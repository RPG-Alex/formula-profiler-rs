...
This report treats each spectrum as **positive** when its molecular formula contains the target element `Mo`. A spectrum is **negative** when its formula does not contain `Mo`.
...
This section shows how many formula-bearing spectra have exactly `k` atoms of `Mo`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 20028 | 20028 | 100.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 20028 | 20028 | 100.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 20028 | 20028 | 100.00% | 100.00% |
