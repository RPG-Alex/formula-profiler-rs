...
This report treats each spectrum as **positive** when its molecular formula contains the target element `Tc`. A spectrum is **negative** when its formula does not contain `Tc`.
...
This section shows how many formula-bearing spectra have exactly `k` atoms of `Tc`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 3661 | 3661 | 100.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 3661 | 3661 | 100.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 3661 | 3661 | 100.00% | 100.00% |
