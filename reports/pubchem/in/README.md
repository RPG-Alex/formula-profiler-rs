...
This report treats each spectrum as **positive** when its molecular formula contains the target element `In`. A spectrum is **negative** when its formula does not contain `In`.
...
This section shows how many formula-bearing spectra have exactly `k` atoms of `In`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 13932 | 13932 | 100.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 13932 | 13932 | 100.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 13932 | 13932 | 100.00% | 100.00% |
