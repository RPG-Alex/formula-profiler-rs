...
This report treats each spectrum as **positive** when its molecular formula contains the target element `Ar`. A spectrum is **negative** when its formula does not contain `Ar`.
...
This section shows how many formula-bearing spectra have exactly `k` atoms of `Ar`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 4077 | 4077 | 100.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 4077 | 4077 | 100.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 4077 | 4077 | 100.00% | 100.00% |
