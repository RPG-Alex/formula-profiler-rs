...
This report treats each spectrum as **positive** when its molecular formula contains the target element `Fr`. A spectrum is **negative** when its formula does not contain `Fr`.
...
This section shows how many formula-bearing spectra have exactly `k` atoms of `Fr`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 105 | 105 | 100.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 105 | 105 | 100.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 105 | 105 | 100.00% | 100.00% |
