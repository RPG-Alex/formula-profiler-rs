...
This report treats each spectrum as **positive** when its molecular formula contains the target element `Sr`. A spectrum is **negative** when its formula does not contain `Sr`.
...
This section shows how many formula-bearing spectra have exactly `k` atoms of `Sr`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 8275 | 8275 | 100.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 8275 | 8275 | 100.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 8275 | 8275 | 100.00% | 100.00% |
