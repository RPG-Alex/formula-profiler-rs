...
This report treats each spectrum as **positive** when its molecular formula contains the target element `Sc`. A spectrum is **negative** when its formula does not contain `Sc`.
...
This section shows how many formula-bearing spectra have exactly `k` atoms of `Sc`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 3507 | 3507 | 100.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 3507 | 3507 | 100.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 3507 | 3507 | 100.00% | 100.00% |
