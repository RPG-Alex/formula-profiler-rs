...
This report treats each spectrum as **positive** when its molecular formula contains the target element `Be`. A spectrum is **negative** when its formula does not contain `Be`.
...
This section shows how many formula-bearing spectra have exactly `k` atoms of `Be`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 3219 | 3219 | 100.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 3219 | 3219 | 100.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 3219 | 3219 | 100.00% | 100.00% |
