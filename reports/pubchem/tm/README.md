...
This report treats each spectrum as **positive** when its molecular formula contains the target element `Tm`. A spectrum is **negative** when its formula does not contain `Tm`.
...
This section shows how many formula-bearing spectra have exactly `k` atoms of `Tm`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 1263 | 1263 | 100.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 1263 | 1263 | 100.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 1263 | 1263 | 100.00% | 100.00% |
