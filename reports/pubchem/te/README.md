...
This report treats each spectrum as **positive** when its molecular formula contains the target element `Te`. A spectrum is **negative** when its formula does not contain `Te`.
...
This section shows how many formula-bearing spectra have exactly `k` atoms of `Te`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 20419 | 20419 | 100.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 20419 | 20419 | 100.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 20419 | 20419 | 100.00% | 100.00% |
