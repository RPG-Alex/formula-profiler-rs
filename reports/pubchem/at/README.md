...
This report treats each spectrum as **positive** when its molecular formula contains the target element `At`. A spectrum is **negative** when its formula does not contain `At`.
...
This section shows how many formula-bearing spectra have exactly `k` atoms of `At`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 1114 | 1114 | 100.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 1114 | 1114 | 100.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 1114 | 1114 | 100.00% | 100.00% |
