...
This report treats each spectrum as **positive** when its molecular formula contains the target element `Np`. A spectrum is **negative** when its formula does not contain `Np`.
...
This section shows how many formula-bearing spectra have exactly `k` atoms of `Np`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 477 | 477 | 100.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 477 | 477 | 100.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 477 | 477 | 100.00% | 100.00% |
