...
This report treats each spectrum as **positive** when its molecular formula contains the target element `Pr`. A spectrum is **negative** when its formula does not contain `Pr`.
...
This section shows how many formula-bearing spectra have exactly `k` atoms of `Pr`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 3761 | 3761 | 100.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 3761 | 3761 | 100.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 3761 | 3761 | 100.00% | 100.00% |
