...
This report treats each spectrum as **positive** when its molecular formula contains the target element `Bh`. A spectrum is **negative** when its formula does not contain `Bh`.
...
This section shows how many formula-bearing spectra have exactly `k` atoms of `Bh`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 74 | 74 | 100.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 74 | 74 | 100.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 74 | 74 | 100.00% | 100.00% |
