...
This report treats each spectrum as **positive** when its molecular formula contains the target element `Mt`. A spectrum is **negative** when its formula does not contain `Mt`.
...
This section shows how many formula-bearing spectra have exactly `k` atoms of `Mt`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 79 | 79 | 100.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 79 | 79 | 100.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 79 | 79 | 100.00% | 100.00% |
