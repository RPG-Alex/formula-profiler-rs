...
This report treats each spectrum as **positive** when its molecular formula contains the target element `Au`. A spectrum is **negative** when its formula does not contain `Au`.
...
|---|---:|
| Total spectra | 17816 |
| Positive count | 17816 |
| Negative count | 0 |
| Positive percentage | 100.0000% |

## Atom-count distribution

This section shows how many formula-bearing spectra have exactly `k` atoms of `Au`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 17816 | 17816 | 100.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 17816 | 17816 | 100.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 17816 | 17816 | 100.00% | 100.00% |
