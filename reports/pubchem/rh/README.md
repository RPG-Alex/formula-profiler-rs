...
This report treats each spectrum as **positive** when its molecular formula contains the target element `Rh`. A spectrum is **negative** when its formula does not contain `Rh`.
...
|---|---:|
| Total spectra | 14833 |
| Positive count | 14833 |
| Negative count | 0 |
| Positive percentage | 100.0000% |

## Atom-count distribution

This section shows how many formula-bearing spectra have exactly `k` atoms of `Rh`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 14833 | 14833 | 100.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 14833 | 14833 | 100.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 14833 | 14833 | 100.00% | 100.00% |
