...
This report treats each spectrum as **positive** when its molecular formula contains the target element `Cd`. A spectrum is **negative** when its formula does not contain `Cd`.
...
This section shows how many formula-bearing spectra have exactly `k` atoms of `Cd`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 7941 | 7941 | 100.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 7941 | 7941 | 100.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 7941 | 7941 | 100.00% | 100.00% |
