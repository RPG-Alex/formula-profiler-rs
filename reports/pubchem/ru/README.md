...
This report treats each spectrum as **positive** when its molecular formula contains the target element `Ru`. A spectrum is **negative** when its formula does not contain `Ru`.
...
|---|---:|
| Total spectra | 38941 |
| Positive count | 38941 |
| Negative count | 0 |
| Positive percentage | 100.0000% |

## Atom-count distribution

This section shows how many formula-bearing spectra have exactly `k` atoms of `Ru`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 38941 | 38941 | 100.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 38941 | 38941 | 100.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 38941 | 38941 | 100.00% | 100.00% |
