...
This report treats each spectrum as **positive** when its molecular formula contains the target element `Pa`. A spectrum is **negative** when its formula does not contain `Pa`.
...
This section shows how many formula-bearing spectra have exactly `k` atoms of `Pa`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 259 | 259 | 100.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 259 | 259 | 100.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 259 | 259 | 100.00% | 100.00% |
