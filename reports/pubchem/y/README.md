...
This report treats each spectrum as **positive** when its molecular formula contains the target element `Y`. A spectrum is **negative** when its formula does not contain `Y`.
...
This section shows how many formula-bearing spectra have exactly `k` atoms of `Y`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 97036 | 97036 | 100.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 97036 | 97036 | 100.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 97036 | 97036 | 100.00% | 100.00% |
