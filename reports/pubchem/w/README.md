...
This report treats each spectrum as **positive** when its molecular formula contains the target element `W`. A spectrum is **negative** when its formula does not contain `W`.
...
|---|---:|
| Total spectra | 43800 |
| Positive count | 43800 |
| Negative count | 0 |
| Positive percentage | 100.0000% |

## Atom-count distribution

This section shows how many formula-bearing spectra have exactly `k` atoms of `W`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 43800 | 43800 | 100.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 43800 | 43800 | 100.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 43800 | 43800 | 100.00% | 100.00% |
