...
This report treats each spectrum as **positive** when its molecular formula contains the target element `Re`. A spectrum is **negative** when its formula does not contain `Re`.
...
|---|---:|
| Total spectra | 10107 |
| Positive count | 10107 |
| Negative count | 0 |
| Positive percentage | 100.0000% |

## Atom-count distribution

This section shows how many formula-bearing spectra have exactly `k` atoms of `Re`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 10107 | 10107 | 100.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 10107 | 10107 | 100.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 10107 | 10107 | 100.00% | 100.00% |
