...
This report treats each spectrum as **positive** when its molecular formula contains the target element `No`. A spectrum is **negative** when its formula does not contain `No`.
...
This section shows how many formula-bearing spectra have exactly `k` atoms of `No`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 355 | 355 | 100.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 355 | 355 | 100.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 355 | 355 | 100.00% | 100.00% |
