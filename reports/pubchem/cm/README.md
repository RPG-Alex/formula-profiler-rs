...
This report treats each spectrum as **positive** when its molecular formula contains the target element `Cm`. A spectrum is **negative** when its formula does not contain `Cm`.
...
This section shows how many formula-bearing spectra have exactly `k` atoms of `Cm`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 635 | 635 | 100.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 635 | 635 | 100.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 635 | 635 | 100.00% | 100.00% |
