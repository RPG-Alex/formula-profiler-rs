...
This report treats each spectrum as **positive** when its molecular formula contains the target element `Yb`. A spectrum is **negative** when its formula does not contain `Yb`.
...
This section shows how many formula-bearing spectra have exactly `k` atoms of `Yb`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 3273 | 3273 | 100.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 3273 | 3273 | 100.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 3273 | 3273 | 100.00% | 100.00% |
