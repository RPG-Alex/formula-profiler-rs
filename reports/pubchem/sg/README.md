...
This report treats each spectrum as **positive** when its molecular formula contains the target element `Sg`. A spectrum is **negative** when its formula does not contain `Sg`.
...
This section shows how many formula-bearing spectra have exactly `k` atoms of `Sg`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 137 | 137 | 100.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 137 | 137 | 100.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 137 | 137 | 100.00% | 100.00% |
