...
This report treats each spectrum as **positive** when its molecular formula contains the target element `Bi`. A spectrum is **negative** when its formula does not contain `Bi`.
...
This section shows how many formula-bearing spectra have exactly `k` atoms of `Bi`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 15608 | 15608 | 100.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 15608 | 15608 | 100.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 15608 | 15608 | 100.00% | 100.00% |
