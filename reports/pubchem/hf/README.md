...
This report treats each spectrum as **positive** when its molecular formula contains the target element `Hf`. A spectrum is **negative** when its formula does not contain `Hf`.
...
|---|---:|
| Total spectra | 21978 |
| Positive count | 21978 |
| Negative count | 0 |
| Positive percentage | 100.0000% |

## Atom-count distribution

This section shows how many formula-bearing spectra have exactly `k` atoms of `Hf`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 21978 | 21978 | 100.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 21978 | 21978 | 100.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 21978 | 21978 | 100.00% | 100.00% |
