...
This report treats each spectrum as **positive** when its molecular formula contains the target element `Ho`. A spectrum is **negative** when its formula does not contain `Ho`.
...
This section shows how many formula-bearing spectra have exactly `k` atoms of `Ho`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 1792 | 1792 | 100.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 1792 | 1792 | 100.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 1792 | 1792 | 100.00% | 100.00% |
