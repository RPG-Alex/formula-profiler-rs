...
This report treats each spectrum as **positive** when its molecular formula contains the target element `Li`. A spectrum is **negative** when its formula does not contain `Li`.
...
| Metric | Value |
|---|---:|
| Total spectra | 116787 |
| Positive count | 116787 |
| Negative count | 0 |
| Positive percentage | 100.0000% |

## Atom-count distribution

This section shows how many formula-bearing spectra have exactly `k` atoms of `Li`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 116787 | 116787 | 100.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 116787 | 116787 | 100.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 116787 | 116787 | 100.00% | 100.00% |
