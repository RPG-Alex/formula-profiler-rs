...
This report treats each spectrum as **positive** when its molecular formula contains the target element `Eu`. A spectrum is **negative** when its formula does not contain `Eu`.
...
This section shows how many formula-bearing spectra have exactly `k` atoms of `Eu`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 5588 | 5588 | 100.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 5588 | 5588 | 100.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 5588 | 5588 | 100.00% | 100.00% |
