...
This report treats each spectrum as **positive** when its molecular formula contains the target element `Pb`. A spectrum is **negative** when its formula does not contain `Pb`.
...
This section shows how many formula-bearing spectra have exactly `k` atoms of `Pb`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 18185 | 18185 | 100.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 18185 | 18185 | 100.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 18185 | 18185 | 100.00% | 100.00% |
