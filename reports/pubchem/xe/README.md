...
This report treats each spectrum as **positive** when its molecular formula contains the target element `Xe`. A spectrum is **negative** when its formula does not contain `Xe`.
...
This section shows how many formula-bearing spectra have exactly `k` atoms of `Xe`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 588 | 588 | 100.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 588 | 588 | 100.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 588 | 588 | 100.00% | 100.00% |
