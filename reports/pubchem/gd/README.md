...
This report treats each spectrum as **positive** when its molecular formula contains the target element `Gd`. A spectrum is **negative** when its formula does not contain `Gd`.
...
This section shows how many formula-bearing spectra have exactly `k` atoms of `Gd`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 7696 | 7696 | 100.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 7696 | 7696 | 100.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 7696 | 7696 | 100.00% | 100.00% |
