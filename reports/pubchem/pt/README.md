...
This report treats each spectrum as **positive** when its molecular formula contains the target element `Pt`. A spectrum is **negative** when its formula does not contain `Pt`.
...
| Metric | Value |
|---|---:|
| Total spectra | 139380 |
| Positive count | 139380 |
| Negative count | 0 |
| Positive percentage | 100.0000% |

## Atom-count distribution

This section shows how many formula-bearing spectra have exactly `k` atoms of `Pt`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 139380 | 139380 | 100.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 139380 | 139380 | 100.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 139380 | 139380 | 100.00% | 100.00% |
