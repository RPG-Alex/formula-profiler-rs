...
This report treats each spectrum as **positive** when its molecular formula contains the target element `Cf`. A spectrum is **negative** when its formula does not contain `Cf`.
...
This section shows how many formula-bearing spectra have exactly `k` atoms of `Cf`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 230 | 230 | 100.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 230 | 230 | 100.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 230 | 230 | 100.00% | 100.00% |
