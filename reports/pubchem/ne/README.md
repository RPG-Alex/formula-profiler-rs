...
This report treats each spectrum as **positive** when its molecular formula contains the target element `Ne`. A spectrum is **negative** when its formula does not contain `Ne`.
...
This section shows how many formula-bearing spectra have exactly `k` atoms of `Ne`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 225 | 225 | 100.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 225 | 225 | 100.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 225 | 225 | 100.00% | 100.00% |
