# `Ca` profile for `coconut`

This report summarizes how often the target element `Ca` appears across metadata groups in `coconut`.

## How to interpret this report

This report treats a record as **positive** when its molecular formula contains the target element `Ca`. A record is **negative** when its formula does not contain `Ca`.
...
| Positive count | 59 |
| Negative count | 738757 |
| Positive percentage | 0.0080% |
...
|---|---|---:|---:|---:|---:|
| Source dataset | Coconut | 738816 | 59 | 0.01% | 100.00% |
| Source dataset | TOTAL_RECORDS | 738816 | 59 | 0.01% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 738816 | 59 | 0.01% | 100.00% |
