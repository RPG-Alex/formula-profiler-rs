# `O` profile for `coconut`

This report summarizes how often the target element `O` appears across metadata groups in `coconut`.

## How to interpret this report

This report treats a record as **positive** when its molecular formula contains the target element `O`. A record is **negative** when its formula does not contain `O`.
...
| Positive count | 722221 |
| Negative count | 16595 |
| Positive percentage | 97.7538% |
...
|---|---|---:|---:|---:|---:|
| Source dataset | Coconut | 738816 | 722221 | 97.75% | 100.00% |
| Source dataset | TOTAL_RECORDS | 738816 | 722221 | 97.75% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 738816 | 722221 | 97.75% | 100.00% |
