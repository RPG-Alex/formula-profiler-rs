# `S` profile for `coconut`

This report summarizes how often the target element `S` appears across metadata groups in `coconut`.

## How to interpret this report

This report treats a record as **positive** when its molecular formula contains the target element `S`. A record is **negative** when its formula does not contain `S`.
...
| Positive count | 56626 |
| Negative count | 682190 |
| Positive percentage | 7.6644% |
...
|---|---|---:|---:|---:|---:|
| Source dataset | Coconut | 738816 | 56626 | 7.66% | 100.00% |
| Source dataset | TOTAL_RECORDS | 738816 | 56626 | 7.66% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 738816 | 56626 | 7.66% | 100.00% |
