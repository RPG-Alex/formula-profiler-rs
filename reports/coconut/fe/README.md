# `Fe` profile for `coconut`

This report summarizes how often the target element `Fe` appears across metadata groups in `coconut`.

## How to interpret this report

This report treats a record as **positive** when its molecular formula contains the target element `Fe`. A record is **negative** when its formula does not contain `Fe`.
...
| Positive count | 196 |
| Negative count | 738620 |
| Positive percentage | 0.0265% |
...
|---|---|---:|---:|---:|---:|
| Source dataset | Coconut | 738816 | 196 | 0.03% | 100.00% |
| Source dataset | TOTAL_RECORDS | 738816 | 196 | 0.03% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 738816 | 196 | 0.03% | 100.00% |
