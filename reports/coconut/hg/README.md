# `Hg` profile for `coconut`

This report summarizes how often the target element `Hg` appears across metadata groups in `coconut`.

## How to interpret this report

This report treats a record as **positive** when its molecular formula contains the target element `Hg`. A record is **negative** when its formula does not contain `Hg`.
...
| Positive count | 27 |
| Negative count | 738789 |
| Positive percentage | 0.0037% |
...
|---|---|---:|---:|---:|---:|
| Source dataset | Coconut | 738816 | 27 | 0.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 738816 | 27 | 0.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 738816 | 27 | 0.00% | 100.00% |
