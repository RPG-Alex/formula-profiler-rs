# `Sn` profile for `coconut`

This report summarizes how often the target element `Sn` appears across metadata groups in `coconut`.

## How to interpret this report

This report treats a record as **positive** when its molecular formula contains the target element `Sn`. A record is **negative** when its formula does not contain `Sn`.
...
| Positive count | 9 |
| Negative count | 738807 |
| Positive percentage | 0.0012% |
...
|---|---|---:|---:|---:|---:|
| Source dataset | Coconut | 738816 | 9 | 0.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 738816 | 9 | 0.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 738816 | 9 | 0.00% | 100.00% |
