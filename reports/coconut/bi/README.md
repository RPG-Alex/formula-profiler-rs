# `Bi` profile for `coconut`

This report summarizes how often the target element `Bi` appears across metadata groups in `coconut`.

## How to interpret this report

This report treats a record as **positive** when its molecular formula contains the target element `Bi`. A record is **negative** when its formula does not contain `Bi`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | Coconut | 738816 | 7 | 0.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 738816 | 7 | 0.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 738816 | 7 | 0.00% | 100.00% |
