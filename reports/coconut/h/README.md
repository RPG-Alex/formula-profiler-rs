# `H` profile for `coconut`

This report summarizes how often the target element `H` appears across metadata groups in `coconut`.

## How to interpret this report

This report treats a record as **positive** when its molecular formula contains the target element `H`. A record is **negative** when its formula does not contain `H`.
...
| Positive count | 738609 |
| Negative count | 207 |
| Positive percentage | 99.9720% |
...
|---|---|---:|---:|---:|---:|
| Source dataset | Coconut | 738816 | 738609 | 99.97% | 100.00% |
| Source dataset | TOTAL_RECORDS | 738816 | 738609 | 99.97% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 738816 | 738609 | 99.97% | 100.00% |
