# `N` profile for `coconut`

This report summarizes how often the target element `N` appears across metadata groups in `coconut`.

## How to interpret this report

This report treats a record as **positive** when its molecular formula contains the target element `N`. A record is **negative** when its formula does not contain `N`.
...
| Metric | Value |
|---|---:|
| Total molecules | 738816 |
| Positive count | 332846 |
| Negative count | 405970 |
| Positive percentage | 45.0513% |
...
|---|---|---:|---:|---:|---:|
| Source dataset | Coconut | 738816 | 332846 | 45.05% | 100.00% |
| Source dataset | TOTAL_RECORDS | 738816 | 332846 | 45.05% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 738816 | 332846 | 45.05% | 100.00% |
