# `Br` profile for `coconut`

This report summarizes how often the target element `Br` appears across metadata groups in `coconut`.

## How to interpret this report

This report treats a record as **positive** when its molecular formula contains the target element `Br`. A record is **negative** when its formula does not contain `Br`.
...
| Positive count | 14607 |
| Negative count | 724209 |
| Positive percentage | 1.9771% |
...
|---|---|---:|---:|---:|---:|
| Source dataset | Coconut | 738816 | 14607 | 1.98% | 100.00% |
| Source dataset | TOTAL_RECORDS | 738816 | 14607 | 1.98% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 738816 | 14607 | 1.98% | 100.00% |
