# `P` profile for `coconut`

This report summarizes how often the target element `P` appears across metadata groups in `coconut`.

## How to interpret this report

This report treats a record as **positive** when its molecular formula contains the target element `P`. A record is **negative** when its formula does not contain `P`.
...
| Positive count | 14305 |
| Negative count | 724511 |
| Positive percentage | 1.9362% |
...
|---|---|---:|---:|---:|---:|
| Source dataset | Coconut | 738816 | 14305 | 1.94% | 100.00% |
| Source dataset | TOTAL_RECORDS | 738816 | 14305 | 1.94% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 738816 | 14305 | 1.94% | 100.00% |
