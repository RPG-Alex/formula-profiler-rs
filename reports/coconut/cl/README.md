# `Cl` profile for `coconut`

This report summarizes how often the target element `Cl` appears across metadata groups in `coconut`.

## How to interpret this report

This report treats a record as **positive** when its molecular formula contains the target element `Cl`. A record is **negative** when its formula does not contain `Cl`.
...
| Positive count | 31898 |
| Negative count | 706918 |
| Positive percentage | 4.3174% |
...
|---|---|---:|---:|---:|---:|
| Source dataset | Coconut | 738816 | 31898 | 4.32% | 100.00% |
| Source dataset | TOTAL_RECORDS | 738816 | 31898 | 4.32% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 738816 | 31898 | 4.32% | 100.00% |
