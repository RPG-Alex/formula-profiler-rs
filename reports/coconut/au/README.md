# `Au` profile for `coconut`

This report summarizes how often the target element `Au` appears across metadata groups in `coconut`.

## How to interpret this report

This report treats a record as **positive** when its molecular formula contains the target element `Au`. A record is **negative** when its formula does not contain `Au`.
...
| Positive count | 6 |
| Negative count | 738810 |
| Positive percentage | 0.0008% |
...
|---|---|---:|---:|---:|---:|
| Source dataset | Coconut | 738816 | 6 | 0.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 738816 | 6 | 0.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 738816 | 6 | 0.00% | 100.00% |
