# `Zn` profile for `coconut`

This report summarizes how often the target element `Zn` appears across metadata groups in `coconut`.

## How to interpret this report

This report treats a record as **positive** when its molecular formula contains the target element `Zn`. A record is **negative** when its formula does not contain `Zn`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | Coconut | 738816 | 33 | 0.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 738816 | 33 | 0.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 738816 | 33 | 0.00% | 100.00% |
