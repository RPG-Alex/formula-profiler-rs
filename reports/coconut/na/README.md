# `Na` profile for `coconut`

This report summarizes how often the target element `Na` appears across metadata groups in `coconut`.

## How to interpret this report

This report treats a record as **positive** when its molecular formula contains the target element `Na`. A record is **negative** when its formula does not contain `Na`.
...
| Positive count | 1822 |
| Negative count | 736994 |
| Positive percentage | 0.2466% |
...
|---|---|---:|---:|---:|---:|
| Source dataset | Coconut | 738816 | 1822 | 0.25% | 100.00% |
| Source dataset | TOTAL_RECORDS | 738816 | 1822 | 0.25% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 738816 | 1822 | 0.25% | 100.00% |
