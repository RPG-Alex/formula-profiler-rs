# `C` profile for `coconut`

This report summarizes how often the target element `C` appears across metadata groups in `coconut`.

## How to interpret this report

This report treats a record as **positive** when its molecular formula contains the target element `C`. A record is **negative** when its formula does not contain `C`.
...
| Positive count | 738543 |
| Negative count | 273 |
| Positive percentage | 99.9630% |
...
|---|---|---:|---:|---:|---:|
| Source dataset | Coconut | 738816 | 738543 | 99.96% | 100.00% |
| Source dataset | TOTAL_RECORDS | 738816 | 738543 | 99.96% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 738816 | 738543 | 99.96% | 100.00% |
