# `Si` profile for `coconut`

This report summarizes how often the target element `Si` appears across metadata groups in `coconut`.

## How to interpret this report

This report treats a record as **positive** when its molecular formula contains the target element `Si`. A record is **negative** when its formula does not contain `Si`.
...
| Positive count | 380 |
| Negative count | 738436 |
| Positive percentage | 0.0514% |
...
|---|---|---:|---:|---:|---:|
| Source dataset | Coconut | 738816 | 380 | 0.05% | 100.00% |
| Source dataset | TOTAL_RECORDS | 738816 | 380 | 0.05% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 738816 | 380 | 0.05% | 100.00% |
