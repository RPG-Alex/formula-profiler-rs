# `Lu` profile for `coconut`

This report summarizes how often the target element `Lu` appears across metadata groups in `coconut`.

## How to interpret this report

This report treats a record as **positive** when its molecular formula contains the target element `Lu`. A record is **negative** when its formula does not contain `Lu`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | Coconut | 738816 | 4 | 0.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 738816 | 4 | 0.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 738816 | 4 | 0.00% | 100.00% |
