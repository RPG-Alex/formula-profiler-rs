# `K` profile for `coconut`

This report summarizes how often the target element `K` appears across metadata groups in `coconut`.

## How to interpret this report

This report treats a record as **positive** when its molecular formula contains the target element `K`. A record is **negative** when its formula does not contain `K`.
...
| Positive count | 134 |
| Negative count | 738682 |
| Positive percentage | 0.0181% |
...
|---|---|---:|---:|---:|---:|
| Source dataset | Coconut | 738816 | 134 | 0.02% | 100.00% |
| Source dataset | TOTAL_RECORDS | 738816 | 134 | 0.02% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 738816 | 134 | 0.02% | 100.00% |
