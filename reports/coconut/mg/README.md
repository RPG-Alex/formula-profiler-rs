# `Mg` profile for `coconut`

This report summarizes how often the target element `Mg` appears across metadata groups in `coconut`.

## How to interpret this report

This report treats a record as **positive** when its molecular formula contains the target element `Mg`. A record is **negative** when its formula does not contain `Mg`.
...
| Positive count | 108 |
| Negative count | 738708 |
| Positive percentage | 0.0146% |
...
|---|---|---:|---:|---:|---:|
| Source dataset | Coconut | 738816 | 108 | 0.01% | 100.00% |
| Source dataset | TOTAL_RECORDS | 738816 | 108 | 0.01% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 738816 | 108 | 0.01% | 100.00% |
