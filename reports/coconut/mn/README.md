# `Mn` profile for `coconut`

This report summarizes how often the target element `Mn` appears across metadata groups in `coconut`.

## How to interpret this report

This report treats a record as **positive** when its molecular formula contains the target element `Mn`. A record is **negative** when its formula does not contain `Mn`.
...
| Positive count | 12 |
| Negative count | 738804 |
| Positive percentage | 0.0016% |
...
|---|---|---:|---:|---:|---:|
| Source dataset | Coconut | 738816 | 12 | 0.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 738816 | 12 | 0.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 738816 | 12 | 0.00% | 100.00% |
