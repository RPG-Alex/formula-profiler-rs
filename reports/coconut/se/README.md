# `Se` profile for `coconut`

This report summarizes how often the target element `Se` appears across metadata groups in `coconut`.

## How to interpret this report

This report treats a record as **positive** when its molecular formula contains the target element `Se`. A record is **negative** when its formula does not contain `Se`.
...
| Positive count | 109 |
| Negative count | 738707 |
| Positive percentage | 0.0148% |
...
|---|---|---:|---:|---:|---:|
| Source dataset | Coconut | 738816 | 109 | 0.01% | 100.00% |
| Source dataset | TOTAL_RECORDS | 738816 | 109 | 0.01% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 738816 | 109 | 0.01% | 100.00% |
