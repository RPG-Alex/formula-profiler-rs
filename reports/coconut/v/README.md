# `V` profile for `coconut`

This report summarizes how often the target element `V` appears across metadata groups in `coconut`.

## How to interpret this report

This report treats a record as **positive** when its molecular formula contains the target element `V`. A record is **negative** when its formula does not contain `V`.
...
| Positive count | 15 |
| Negative count | 738801 |
| Positive percentage | 0.0020% |
...
|---|---|---:|---:|---:|---:|
| Source dataset | Coconut | 738816 | 15 | 0.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 738816 | 15 | 0.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 738816 | 15 | 0.00% | 100.00% |
