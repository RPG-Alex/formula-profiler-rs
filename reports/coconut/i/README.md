# `I` profile for `coconut`

This report summarizes how often the target element `I` appears across metadata groups in `coconut`.

## How to interpret this report

This report treats a record as **positive** when its molecular formula contains the target element `I`. A record is **negative** when its formula does not contain `I`.
...
| Positive count | 1405 |
| Negative count | 737411 |
| Positive percentage | 0.1902% |
...
|---|---|---:|---:|---:|---:|
| Source dataset | Coconut | 738816 | 1405 | 0.19% | 100.00% |
| Source dataset | TOTAL_RECORDS | 738816 | 1405 | 0.19% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 738816 | 1405 | 0.19% | 100.00% |
