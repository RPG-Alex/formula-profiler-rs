# `Co` profile for `coconut`

This report summarizes how often the target element `Co` appears across metadata groups in `coconut`.

## How to interpret this report

This report treats a record as **positive** when its molecular formula contains the target element `Co`. A record is **negative** when its formula does not contain `Co`.
...
| Positive count | 76 |
| Negative count | 738740 |
| Positive percentage | 0.0103% |
...
|---|---|---:|---:|---:|---:|
| Source dataset | Coconut | 738816 | 76 | 0.01% | 100.00% |
| Source dataset | TOTAL_RECORDS | 738816 | 76 | 0.01% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 738816 | 76 | 0.01% | 100.00% |
