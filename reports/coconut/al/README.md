# `Al` profile for `coconut`

This report summarizes how often the target element `Al` appears across metadata groups in `coconut`.

## How to interpret this report

This report treats a record as **positive** when its molecular formula contains the target element `Al`. A record is **negative** when its formula does not contain `Al`.
...
| Positive count | 26 |
| Negative count | 738790 |
| Positive percentage | 0.0035% |
...
|---|---|---:|---:|---:|---:|
| Source dataset | Coconut | 738816 | 26 | 0.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 738816 | 26 | 0.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 738816 | 26 | 0.00% | 100.00% |
