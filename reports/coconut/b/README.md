# `B` profile for `coconut`

This report summarizes how often the target element `B` appears across metadata groups in `coconut`.

## How to interpret this report

This report treats a record as **positive** when its molecular formula contains the target element `B`. A record is **negative** when its formula does not contain `B`.
...
| Positive count | 197 |
| Negative count | 738619 |
| Positive percentage | 0.0267% |
...
|---|---|---:|---:|---:|---:|
| Source dataset | Coconut | 738816 | 197 | 0.03% | 100.00% |
| Source dataset | TOTAL_RECORDS | 738816 | 197 | 0.03% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 738816 | 197 | 0.03% | 100.00% |
