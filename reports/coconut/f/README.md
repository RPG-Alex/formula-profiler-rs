# `F` profile for `coconut`

This report summarizes how often the target element `F` appears across metadata groups in `coconut`.

## How to interpret this report

This report treats a record as **positive** when its molecular formula contains the target element `F`. A record is **negative** when its formula does not contain `F`.
...
| Positive count | 1315 |
| Negative count | 737501 |
| Positive percentage | 0.1780% |
...
|---|---|---:|---:|---:|---:|
| Source dataset | Coconut | 738816 | 1315 | 0.18% | 100.00% |
| Source dataset | TOTAL_RECORDS | 738816 | 1315 | 0.18% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 738816 | 1315 | 0.18% | 100.00% |
